...
public class TemplateDefinition extends DomainWrapper<TemplateDefinitionDto> {
   ...
   protected TemplateDefinition(ApiContext<AbiquoApi> context, TemplateDefinitionDto target) {
   ...
   public static class Builder {
      ...
      public Builder(final ApiContext<AbiquoApi> context, final Enterprise enterpirse) {
         super();
